    ...
    public partial class MyFirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nchar(32)", fixedLength: true, maxLength: 32, nullable: false, comment: "Id"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "名字")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "名字"),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false, comment: "创建时间"),
                    Sex = table.Column<int>(type: "int", nullable: false, comment: "性别"),
                    IntV = table.Column<int>(type: "int", nullable: false, comment: "整形"),
                    DouV = table.Column<double>(type: "float", nullable: false, comment: "浮点数")
                },
                constraints: table =>
                {
