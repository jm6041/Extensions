...
namespace Microsoft.AspNet.OData.Common
{
    ...
    internal static class Error
    {
        ...
        {
            return new ArgumentException(Error.Format("CommonWebApiResources.ArgumentInvalidHttpUriScheme{0}", actualValue, HttpScheme, HttpsScheme), parameterName);
        }
        ...
        {
            return new ArgumentException(Error.Format("CommonWebApiResources.ArgumentInvalidAbsoluteUri{0}", actualValue), parameterName);
        }
        ...
        {
            return new ArgumentException(Error.Format("CommonWebApiResources.ArgumentUriHasQueryOrFragment{0}", actualValue), parameterName);
        }
        ...
        {
            return Error.Argument(parameterName, "CommonWebApiResources.ArgumentNullOrEmpty{0}", parameterName);
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format("CommonWebApiResources.ArgumentMustBeGreaterThanOrEqualTo{0}", minValue));
        }
        ...
        {
            return new ArgumentOutOfRangeException(parameterName, actualValue, Error.Format("CommonWebApiResources.ArgumentMustBeLessThanOrEqualTo{0}", maxValue));
        }
